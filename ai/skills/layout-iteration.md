...
> **Commands are project-specific.** The app start/health/URL commands below are the
> full-stack-template defaults (Taito CLI). If `ai/project.md` defines different commands in its
> **Running the app** table, use those instead.
