...
> **Commands are project-specific.** The lint/typecheck and unit-test commands below are the
> full-stack-template defaults (Taito CLI). If `ai/project.md` defines different commands, use
> those instead.
